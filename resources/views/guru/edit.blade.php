                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" placeholder="Name" name="jabatan" id="jabatan" required>
                                        ...
                                        @endforeach
                                        @if($guru->jabatan_id != 6)
                                        <option value="6">Guru</option>
                                        @endif
                                        <option value="{{ $guru->jabatan_id }}" selected>{{ $guru->jabatans->jabatan }}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="masa_jabatan_awal" type="date" class="form-control{{ $errors->has('masa_jabatan_awal') ? ' is-invalid' : '' }}" name="masa_jabatan_awal" value="{{ $guru->masa_jabatan_awal }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="masa_jabatan_akhir" type="date" class="form-control{{ $errors->has('masa_jabatan_akhir') ? ' is-invalid' : '' }}" name="masa_jabatan_akhir" value="{{ $guru->masa_jabatan_akhir }}" required>
